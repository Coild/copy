...
<body>
  ...
  <tr>
    ...
    <td align="center"></td>
    <td align="center"><a href="<?php echo site_url() . 'Pasien/printSkl' ?>" class="btn btn-danger" name="cetak">DOWNLOAD</a>&nbsp;(Gunakan menu Download, apabila ingin mencetak Nomer Antrian Anda)</td>
  </tr>
  </table>
</body>
