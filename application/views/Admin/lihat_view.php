        ...
        <div class="card-body">
            <form action="" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="no_identitas" disabled value="<?php echo $user['nim']; ?>" class="form-control" size="4">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="tempat_lahir" disabled value="<?php echo $user['tmp_lahir']; ?>" class="form-control" size="4">
                    </div>
                    <div class="col-sm-5">
                        <input type="date" name="tanggal_lahir" disabled value="<?php echo $user['tgl_lahir']; ?>" class="form-control" size="4">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="pekerjaan" disabled value="<?php echo $user['prodi']; ?>" class="form-control" size="4">
                    </div>
                </div>
