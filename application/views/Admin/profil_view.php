      ...
      <form action="" method="post">
        <div class="form-group row">
          <table id="dataTable" width="100%" cellspacing="0">
            ...
            <tr>
              <td>
                <center><?php echo $user['nama']; ?></center>
              </td>
            </tr>
          </table>
        </div>
    ...
    <div class="card-body">
      <form action="" method="post">
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" name="nim" disabled value="<?php echo $user['nim']; ?>" class="form-control" size="4">
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" name="jk" disabled value="<?php if ($user['gender'] == 'L') {
                                                            echo "Laki-laki";
                                                          } else {
                                                            echo "Perempuan";
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-4">
            <input type="text" name="tmp_lahir" disabled value="<?php echo $user['tmp_lahir']; ?>" class="form-control" size="4">
          </div>
          <div class="col-sm-5">
            <input type="date" name="ttgl_lahir" disabled value="<?php echo $user['tgl_lahir']; ?>" class="form-control" size="4">
          </div>
        </div>
        <div class="form-group row">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('akses/updateProfile'); ?>" method="post" enctype="multipart/form-data">
          ...
          <!-- <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="text" name="nim" id="username" value="<?php echo $user['nim']; ?>" size="4" class="form-control" required>
            </div>
          </div> -->
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-3">
              <input type="text" name="tmp_lahir" id="tempat_lahir" value="<?php echo $user['tmp_lahir']; ?>" size="4" class="form-control" required>
            </div>
            <div class="col-sm-5">
              <input type="date" name="tgl_lahir" id="tanggal_lahir" value="<?php echo $user['tgl_lahir']; ?>" size="4" class="form-control" required>
            </div>
          </div>
